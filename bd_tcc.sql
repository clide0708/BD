...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 13-Out-2025 às 04:40
...
(2, 'Máquina Declinada Supino e Crucifixo', 'peitoral', 'Deite-se em banco declinado; no supino empurre a barra/pegada para cima até estender os braços; no crucifixo abra os braços com leve flexão nos cotovelos e retorne controlado.', NULL, NULL, 'global', 'normal'),
(3, 'Supino com Halteres', 'peitoral', 'Deite-se no banco, segure halteres alinhados ao peito, empurre para cima até braços estendidos e desça controladamente.', NULL, NULL, 'global', 'normal'),
(4, 'Crucifixo com Halteres', 'peitoral', 'Deite-se, braços semiflexionados; abra lateralmente até sentir alongamento no peitoral e traga os halteres de volta com controle.', NULL, NULL, 'global', 'normal'),
(5, 'Flexão de Braço', 'peitoral', 'Posição de prancha com mãos alinhadas ao peito; flexione os cotovelos até o peito quase tocar o chão e empurre de volta até estender os braços.', NULL, NULL, 'global', 'normal'),
(6, 'Fly', 'peitoral', 'Em banco reto ou inclinado, com leve flexão nos cotovelos abra os braços lateralmente e junte-os à frente contraindo o peitoral.', NULL, NULL, 'global', 'normal'),
(7, 'Paralela', 'peitoral', 'Suspenda-se nas barras paralelas, incline o tronco levemente à frente, desça flexionando os cotovelos e empurre até estender os braços.', NULL, NULL, 'global', 'normal'),
(8, 'Máquina de Crucifixo Inclinada', 'peitoral', 'Sente-se na máquina inclinada, segure as alças e junte-as à frente do peito com movimento controlado e ênfase na contração.', NULL, NULL, 'global', 'normal'),
(9, 'Supino com Barra', 'peitoral', 'Deite-se no banco, segure a barra à largura dos ombros, desça ao peito mantendo controle e empurre até estender os braços.', NULL, NULL, 'global', 'normal'),
(10, 'Cross Over', 'peitoral', 'Em pé entre os cabos, segure as alças e leve-as à frente do corpo com leve arco no tronco, cruzando as mãos se desejar foco na parte inferior do peitoral.', NULL, NULL, 'global', 'normal'),
(11, 'Voador para Peitoral', 'peitoral', 'Sente-se no peck-deck, apoie os braços/antebraços e junte as alças concentrando a contração no centro do peitoral.', NULL, NULL, 'global', 'normal'),
...
(1, 'apple', 'maçã', 'en', 'pt', '2025-10-02 22:55:48', '2025-10-12 19:16:24'),
...
(40, 'applesauce', 'molho de maçã', 'en', 'pt', '2025-10-06 01:37:51', '2025-10-12 19:16:21'),
(42, 'apple juice', 'suco de maçã', 'en', 'pt', '2025-10-06 01:37:54', '2025-10-12 19:16:21'),
(44, 'apple cider', 'cidra de maçã', 'en', 'pt', '2025-10-06 01:37:57', '2025-10-12 19:16:21'),
(46, 'apple jelly', 'geleia de maçã', 'en', 'pt', '2025-10-06 01:37:59', '2025-10-12 19:16:21'),
...
(53, 'apple butter', 'doce de maçã', 'en', 'pt', '2025-10-06 01:49:57', '2025-10-12 19:16:21'),
...
(73, 'apple pie spice', 'especiarias para torta de maçã', 'en', 'pt', '2025-10-06 02:03:46', '2025-10-12 19:16:21'),
(75, 'apple pie filling', 'recheio de torta de maçã', 'en', 'pt', '2025-10-06 02:03:48', '2025-10-12 19:16:21'),
(77, 'apple cider vinegar', 'vinagre de maçã', 'en', 'pt', '2025-10-06 02:03:49', '2025-10-12 19:16:21'),
(79, 'applewood smoked bacon', 'bacon defumado applewood', 'en', 'pt', '2025-10-06 02:03:50', '2025-10-12 19:16:21'),
