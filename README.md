...
Como posso truncar todas as tabelas do meu banco de dados MySQL (com exceção a tabela 'recuperacao_senha', 'exercicios', 'devs', 'exercadaptados', 'videos', 'traducoes_alimentos', 'nutrientes' e 'pagamentos') de uma só vez?
